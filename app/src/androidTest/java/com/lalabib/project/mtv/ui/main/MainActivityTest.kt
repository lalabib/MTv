...
class MainActivityTest {
    ...
    fun loadMovies(){
        ...
        onView(withId(R.id.rvMovie)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(dummyMovie.results.size))
    }
    ...
    fun loadTvShows(){
        ...
        onView(withId(R.id.rvTv)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(dummyTVShow.results.size))
    }
